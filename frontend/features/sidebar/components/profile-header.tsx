...
const SOCIAL_ITEMS: SocialItem[] = [
    { icon: FaGithub, label: "GitHub", url: "https://github.com/hassanabbasdeveloper" },
    ...
    return (
        <div className="relative z-10 flex flex-col pt-8 xl:pt-6 pb-2 xl:px-5">
            ...
            <p className="text-base xl:text-base text-zinc-300 leading-snug md:leading-relaxed font-light mb-2 text-center px-3">
                I build modern web experiences and AI-powered products that are practical, clean, and user-focused.
                Explore my projects, skills, and journey through this portfolio.
            </p>
